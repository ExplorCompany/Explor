...
bot_token = "414427015:AAFzu0I9x43GamfH59D6SXd06UUvgtwXgy0" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		morgan_team = '/root/MaTaDoR/cli'
	elseif not server_user:match("^root$") then
		morgan_team = '/home/'..server_user..'/MaTaDoR/cli'
	end
  ...
  config = {
    ...
    sudo_users = {319654228,00000000},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..morgan_team..'/data/moderation.json'},
    info_text = [[
*》Explor Helper Bot V1*
	
》[morgan Helper](https://github.com/)

*》Admins :*
*》Founder & Developer :* [ ](Telegram.Me/)
_》Developer :_ [kiarashNASA](Telegram.Me/kiarashNASA)
_》Developer & Sponser :_ [](Telegram.Me/)

*》Special thanks to :*
》[NASA](Telegram.Me/kiarashNASA)

*》Our channel :*
》[morgan](Telegram.Me/morgan_team)
]],
  }
