--Begin Core.lua By #ExplorCompany
...
local settings = data[tostring(GP_id)]["settings"]
 ...
 text = '_Welcome To_ *More Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> Flood Sensitivity ', callback_data = 'ExplorCompany'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="ExplorCompany"},
			{text = "➖", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = '> Character Sensitivity ', callback_data = 'ExplorCompany'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="ExplorCompany"},
			{text = "➖", callback_data='/chardown:'..GP_id}
		},
		{
			{text = '> Flood Check Time ', callback_data = 'ExplorCompany'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="ExplorCompany"},
 ...
 text = '_به تنظیمات بیشتر خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> حداکثر پیام های مکرر ', callback_data = 'ExplorCompany'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="ExplorCompany"},
		...
		{
			{text = '> حداکثر حروف مجاز ', callback_data = 'ExplorCompany'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="ExplorCompany"},
		...
		{
			{text = '> زمان بررسی پیام های مکرر ', callback_data = 'ExplorCompany'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="ExplorCompany"},
...
local lang = redis:get(hash) 
 ...
 text = '_Welcome To_ *Group Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = "> Lock Edit", callback_data='ExplorCompany'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "> Lock Link", callback_data='ExplorCompany'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "> Lock Hashtags", callback_data='ExplorCompany'}, 
			{text = lock_hashtags, callback_data="/lockhashtags:"..GP_id}
		},
		{
			{text = "> Lock Join", callback_data='ExplorCompany'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "> Lock Flood", callback_data='ExplorCompany'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "> Lock Spam", callback_data='ExplorCompany'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "> Lock Mention", callback_data='ExplorCompany'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "> Lock Persian", callback_data='ExplorCompany'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "> Lock English", callback_data='ExplorCompany'}, 
			{text = english, callback_data="/lockeng:"..GP_id}
		},
		{
			{text = "> Lock Webpage", callback_data='ExplorCompany'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "> Lock Markdown", callback_data='ExplorCompany'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "> Lock Pin", callback_data='ExplorCompany'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "> Lock Bots", callback_data='ExplorCompany'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		
		
		{
			{text = "> Lock Fosh", callback_data='ExplorCompany'}, 
			{text = fosh, callback_data="/lockfosh:"..GP_id}
		},
		{
			{text = "> Lock Ads", callback_data='ExplorCompany'}, 
			{text = ads, callback_data="/lockads:"..GP_id}
		},
		{
			{text = "> Lock Tabchi", callback_data='ExplorCompany'}, 
			{text = lock_tabchi, callback_data="/locktabchi:"..GP_id}
		},
		{
			{text = "> Lock Username", callback_data='ExplorCompany'}, 
			{text = lock_username, callback_data="/lockusername:"..GP_id}
		},
		{
			{text = "> Lock Emoji", callback_data='ExplorCompany'}, 
			{text = emoji, callback_data="/lockemoji:"..GP_id}
		},
		{
			{text = "> Lock Views", callback_data='ExplorCompany'}, 
		...
		{
			{text = "> Group Welcome", callback_data='ExplorCompany'}, 
 ...
 text = '_به تنظیمات گروه خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = "> قفل ویرایش", callback_data='ExplorCompany'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "> قفل لینک", callback_data='ExplorCompany'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "> قفل هشتگ", callback_data='ExplorCompany'}, 
			{text = lock_hashtags, callback_data="/lockhashtags:"..GP_id}
		},
		{
			{text = "> قفل ورود", callback_data='ExplorCompany'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "> قفل پیام های مکرر", callback_data='ExplorCompany'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "> قفل هرزنامه", callback_data='ExplorCompany'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "> قفل فراخوانی", callback_data='ExplorCompany'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "> قفل فارسی", callback_data='ExplorCompany'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "> قفل انگلیسی", callback_data='ExplorCompany'}, 
			{text = english, callback_data="/lockeng:"..GP_id}
		},
		{
			{text = "> قفل صفحات وب", callback_data='ExplorCompany'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "> قفل فونت", callback_data='ExplorCompany'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "> قفل سنجاق کردن", callback_data='ExplorCompany'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "> قفل ربات ها", callback_data='ExplorCompany'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		...
		{
			{text = "> قفل فحش", callback_data='ExplorCompany'}, 
			{text = fosh, callback_data="/lockfosh:"..GP_id}
		},
		{
			{text = "> قفل تبلیغات", callback_data='ExplorCompany'}, 
			{text = ads, callback_data="/lockads:"..GP_id}
		},
		{
			{text = "> قفل تبچی", callback_data='ExplorCompany'}, 
			{text = lock_tabchi, callback_data="/locktabchi:"..GP_id}
		},
		{
			{text = "> قفل یوزرنیم", callback_data='ExplorCompany'}, 
			{text = lock_username, callback_data="/lockusername:"..GP_id}
		},
		{
			{text = "> قفل اموجی", callback_data='ExplorCompany'}, 
			{text = emoji, callback_data="/lockemoji:"..GP_id}
		},
		{
			{text = "> قفل بنر", callback_data='ExplorCompany'}, 
			{text = views, callback_data="/lockviews:"..GP_id}
		},
		...
		{
			{text = "> خوشآمد گویی", callback_data='ExplorCompany'}, 
			{text = group_welcone, callback_data="/welcome:"..GP_id}
		},
		{
...
local lang = redis:get(hash) 
   ...
   if not lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> Mute All", callback_data='ExplorCompany'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "> Mute Gifs", callback_data='ExplorCompany'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "> Mute Text", callback_data='ExplorCompany'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "> Mute Inline", callback_data='ExplorCompany'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "> Mute Game", callback_data='ExplorCompany'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "> Mute Photo", callback_data='ExplorCompany'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "> Mute Video", callback_data='ExplorCompany'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "> Mute Audio", callback_data='ExplorCompany'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "> Mute Voice", callback_data='ExplorCompany'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "> Mute Sticker", callback_data='ExplorCompany'}, 
			{text = mute_sticker, callback_data="/settingsticker:"..GP_id}
		},
		{
			{text = "> Mute Contact", callback_data='ExplorCompany'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "> Mute Forward", callback_data='ExplorCompany'}, 
			{text = mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "> Mute Location", callback_data='ExplorCompany'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "> Mute Document", callback_data='ExplorCompany'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "> Mute TgService", callback_data='ExplorCompany'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "> Mute Keyboard", callback_data='ExplorCompany'}, 
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> بیصدا همه", callback_data='ExplorCompany'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "> بیصدا تصاویر متحرک", callback_data='ExplorCompany'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "> بیصدا متن", callback_data='ExplorCompany'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "> بیصدا اینلاین", callback_data='ExplorCompany'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "> بیصدا بازی", callback_data='ExplorCompany'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "> بیصدا عکس", callback_data='ExplorCompany'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "> بیصدا فیلم", callback_data='ExplorCompany'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "> بیصدا آهنگ", callback_data='ExplorCompany'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "> بیصدا صدا", callback_data='ExplorCompany'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "> بیصدا استیکر", callback_data='ExplorCompany'}, 
			{text = mute_sticker, callback_data="/settingsticker:"..GP_id}
		},
		{
			{text = "> بیصدا مخاطب", callback_data='ExplorCompany'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "> بیصدا نقل و قول", callback_data='ExplorCompany'}, 
			{text = settings.mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "> بیصدا موقعیت", callback_data='ExplorCompany'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "> بیصدا فایل", callback_data='ExplorCompany'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "> بیصدا خدمات تلگرام", callback_data='ExplorCompany'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "> بیصدا کیبورد", callback_data='ExplorCompany'}, 
			{text = mute_keyboard, callback_data="/mutekeyboard:"..GP_id}
		},
		{
			{text = '> بازگشت ', callback_data = '/option:'..GP_id}
...
if matches[1] == '/matador' then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '> Our GitHub ', url = 'https://www.github.com/ExplorCompany'}
		},
		{
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '> گیت هاب تیم ', url = 'https://www.github.com/ExplorCompany'}
		},
		{
...
*》Bridges :《*
_》Pv : _[](Telegram.Me/)
_》PvResan : _[ PvResan](Telegram.Me/)
*-------------------------*
*》Expertise :《*
