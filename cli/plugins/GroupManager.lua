--Begin GroupManager.lua By @kiarashNASA
...
local function delmsg (MaTaDoR,kiarashNASA)
    msgs = MaTaDoR.msgs 
    for k,v in pairs(kiarashNASA.messages_) do
        msgs = msgs - 1
        tdcli.deleteMessages(v.chat_id_,{[0] = v.id_}, dl_cb, cmd)
        if msgs == 1 then
            tdcli.deleteMessages(kiarashNASA.messages_[0].chat_id_,{[0] = kiarashNASA.messages_[0].id_}, dl_cb, cmd)
            return false
        end
    end
    tdcli.getChatHistory(kiarashNASA.messages_[0].chat_id_, kiarashNASA.messages_[0].id_,0 , 100, delmsg, {msgs=msgs})
end
...
if not lang then
 return "》*#lø¢κ* _ρøšт łš αlяeαđч lø¢κeđ_🔒\n*〰〰〰〰〰〰〰〰*\n*øяđeявч*: [@"..check_markdown(msg.from.username or "kiarashNASA").."]"
elseif lang then
 return "》ارسال #لینک در گروه  از قبلا ممنوع است🔒\n*〰〰〰〰〰〰〰〰*\nسفارش توسط : [@"..check_markdown(msg.from.username or "kiarashNASA").."]"
end
else
...
⇚ Funhelp
➖➖➖➖➖➖
↺ This guide is for managers / owners only!
➖➖➖➖➖➖
↺ This means that only the managers / owners of the group can use the above commands!
➖➖➖➖
@ExplorCompany
...
↫ راهنمای سودو
⇚ نمایش راهنمای سودو و ادمین ربات
➖➖➖➖➖➖
↫ راهنمای مدیریتی
⇚ نمایش راهنمای مالک و مدیر گروه
➖➖➖➖➖➖
↫ راهنمای قفلی
⇚ نمایش راهنمای قفل ها
➖➖➖➖➖➖
↫ راهنمای بیصدا
⇚ نمایش راهنمای بیصداها
➖➖➖➖➖➖
↫ راهنمای فان
⇚ نمایش راهنمای فان
➖➖➖➖➖➖
...
*Setlang* `[en , fa]`
➖➖➖
🔖Channel: @ExplorCompany
💻powered by :@kiarashNASA
]]
return text
end
...
*🔖Explor Ɓσт тɢ 💤*
📜 دوستان گرامی لطفا این متن را با دقت بخوانید :

دوستان عزیز ربات ما به دلیل خواهان زیاد هر روز در حال کپی شدن از طریق برخی ادمهای کلاهبردار میباشد
به همین دلیل برای جلوگیری از فعالیت این افراد سودجو به نکات زیر توجه فرماید :

1. ربات را تنها از ایدی ادمینهایی که اینجا ذکر میشود تهیه کنید .

🤖 @explorsupportbot 
 ────────
👥 ادمینهاے Explor тεαм 

🔺 @kiarashNASA
🔺 @explorsupportbot


2. برای پرداخت و تمدید ربات بهتر است از خود ربات و با دستور (پنل) انجام دهید. زیرا مطمئن تر و امن تر است.

3. از طریق سایت نیز میتوانید پرداخت را انجام داده و به ما اطلاع دهید تا ادمینها در اسرع وقت به گروهتان امده و تمدید را انجام دهند.
https://idpay.ir/explor
4. اگر به صورت کارت به کارت تمدید میکنید به خاطر داشته باشید که فقط این شماره حساب

6393461036069371
به نام اقای دیلم صالحی

معتبر میباشد و بعد از پرداخت هم از فیش عکس گرفته و برای ادمینهایی که نام انها ذکر شد بفرستید.

____

پرداخت به غیر از این ۴ روش برای ما قابل قبول نیست و مسئولیت آن را بر عهده نخواهیم گرفت.

⚠️⚠️⚠️ هشدار : ادمین های ما به هیچ وجه پی وی مشتریان برای خرید ربات پیام نخواهند داد و اگر کسی همچین پیامی برای شما ارسال نماید کلاهبردار است لذا خواهشمندیم از پی وی کاربر اسکرین شات تهیه نموده و همراه با ایدی و پیام فوروارد شده شخص کلاهبردار برای ما ارسال نمائید.

⚠️⚠️⚠️ هشدار : در صورت فریب خوردن توسط افراد کلاه بردار و شیاد به ما هیچ ارتباطی پیدا نخواهد کرد و مسولیتی در مقابل شخص مال باخته نخواهیم داشت لذا در خرید خود دقت فرماید

📛📛 افراد کلابردار و شیاد در هر ظاهری ممکن است ظاهر شوند 📛📛

🏦 تعرفه ربات ضد اسپم  Explor Bot
─┅━━━━━━━┅─
👥 یک ماهه   5  تومان 💶
👥 دو ماهه   1۰ تومان 💶
👥 سه ماهه 💶 2۰ تومان 💶
────────
❌ شارژ به هیچ وجه قبول نمیڪنیم سوال نڪنید.
────────
💰پرداخت از طریق سایت 
🌐 https://idpay.ir/explor
────────
💳 پرداخت از طریق ڪارت 
🔰 6393461036069371
⭕️ بانک سینا به نام اقا دیلم صالحی
─┅━━━━━━━┅─
‼️ نڪته : بعد از پرداخت هزینه عڪس فیش را به یڪے از ادمینهاے ربات بفرستید
─┅━━━━━━━┅─
🔱 راه ارتباطے با ادمین ها و گزارش مشڪلات و دریافت ربات براے گروهتون
🆔 @explorsupportbot
────────
⚠️ از ارسال هرگونه پیام مڪرر و خارج از موضوعات مربوط به ربات خوددارے ڪنید
(در غیر اینصورت بلاک خواهید شد)
🆔 @ExplorCompany
...
if not lang then
text = [[
̶e̶x̶p̶l̶o̶r̶ ̶M̶υ̶т̶є̶т̶ι̶м̶є̶ ̶Ƈ̶σ̶м̶м̶α̶η̶ɗ̶ѕ:
